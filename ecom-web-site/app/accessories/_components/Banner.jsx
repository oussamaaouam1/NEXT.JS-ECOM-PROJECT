...
function Banner() {
  return (
    <section className="relative bg-[url('/accBG.jpg')] bg-cover bg-center bg-no-repeat">
      ...
      <div className="relative mx-auto max-w-screen-xl px-4 py-32 sm:px-6 lg:flex lg:h-screen lg:items-start lg:px-8">
        <div className="max-w-xl  ltr:sm:text-left rtl:sm:text-right">
          <h1 className="text-3xl font-extrabold text-primary sm:text-5xl">
            ACTIVE <span className="text-black">sports wear ACCESSORIES</span>
          ...
          <div className="mt-8 flex flex-wrap gap-4 text-center ">
            ...
            onClick={()=>{
                window.scrollTo({
                  top: window.innerHeight * 1.06, // Scroll to 60% of the viewport height
